...
<div class="main-content">
    ...
    <div id="section-lista-espera">
        <div class="content-header mb-4">
            <h2 class="content-title text-primary"><i class="fas fa-list-ol"></i> Lista de Espera (Prioridade)</h2>
                            ...
                            @forelse($pacientes as $paciente)
                                ...
                                <tr>
                                    ...
                                    <td class="text-end pe-4">
                                        <a href="{{ route('medico.atender', $paciente->id) }}" class="btn btn-primary btn-sm px-3">
                                            Atender
                                        </a>
                                    </td>
                                </tr>
