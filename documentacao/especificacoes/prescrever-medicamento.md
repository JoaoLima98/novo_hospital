...
## 2. Pré-condições
 ...
 - O paciente ter sido selecionado na [fila de atendimento](https://github.com/JoaoLima98/novo_hospital/blob/main/documentacao/especificacoes/visualizar-fila-atendimento.md#caso-de-uso-visualizar-fila-de-atendimento)
   
## 3. Fluxo Principal

### a) Nova posologia

1. Ao escolher o paciente, o ator poderá adicionar uma posologia (Posologia é o estudo e a definição da forma correta de utilizar um medicamento);
2. Ao selecionar adicionar posologia, o sistema irá gerar um novo card de posologia na lista;
3. No card uma nova posologia deve apresentar os campos:
...
4. Se o médico precisar escrever mais alguma instrução ou observação, poderá escrever no campo de observações adicionais (Textarea).
5. Por fim ele ir pressionar o botão **"Gerar prescrição"** para finalizar a prescrição medica e o paciente **DEVE** sair da lista de prioridade e ser encaminhado para o farmacêutico.
