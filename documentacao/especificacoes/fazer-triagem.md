...
4.  O sistema exibe um modal, com o formulário para registro dos dados da triagem com os seguintes campos:
    ...
    * **Pressão Arterial:** (Devem ser 2 valores númericos que formam este valor, ex: 12x8 ou 14x9;
    ...
    * **Classificação de Risco/Protoco Manchester:** (Seleção de prioridade/cor: Vermelho, Laranja, Amarelo, Verde, Azul);
    ...
    * **Acidente de veículo:** (Sim ou não **(Boolean - Toggle/Switch)**, se sim deve aparecer um **Radio** para selecionar o **Tipo de envolvimento: Condutor, Passageiro ou Pedestre**; Se não, este radio não deve aparecer;
